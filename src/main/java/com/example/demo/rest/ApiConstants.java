...
public class ApiConstants {
    ...
    public static final String BOOKING_ITEM = ApiConstants.PARTICIPANT_COLLECTION + "/{bookingId}";
    
    public static final String SEMINAR_COLLECTION = ApiConstants.API_ROOT + "/seminars";
    public static final String SEMINAR_ITEM = ApiConstants.PARTICIPANT_COLLECTION + "/{seminarId}";
}
